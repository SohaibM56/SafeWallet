...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final bool addBottomPadding; // 👈 New parameter
  final double? bottomPadding; // 👈 Custom bottom padding value
  ...
  const CustomAppBar({
    ...
    this.addBottomPadding = false, // 👈 Default = false
    this.bottomPadding, // 👈 Optional custom value
  });
