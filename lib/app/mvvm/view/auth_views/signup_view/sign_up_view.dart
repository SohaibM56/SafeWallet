          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: authController.rXfile.value != null
                                ? DecorationImage(image: FileImage(authController.rXfile.value!), fit: BoxFit.cover)
                                : null,
                          ),
                          child: authController.rXfile.value == null ? ClipOval(child: Image.asset(AppAssets.placeholder, fit: BoxFit.cover)) : null,
                        );
                      }),
                      Positioned(
                        bottom: 5.h,
                          ...
                          onTap: () {
                            Utils.showPickImageOptionsDialog(
                              ...
                              onCameraTap: () async {
                                ...
                                await authController.pickProfileFromCamera();
                              },
                              onGalleryTap: () async {
                                Navigator.of(context).pop();
                                await authController.pickProfileFromGallery();
                              },
                            );
                          },
                          child: SvgPicture.asset(AppAssets.cameraIc, height: 25.h),
                        ),
                      ),
                    ],
                  ).animate().fadeIn(duration: 600.ms, delay: 300.ms).scale(begin: const Offset(0.7, 0.7), curve: Curves.easeOutBack),
                ),
                20.h.height,
                AppCustomField(
                ...
                ).animate(delay: 500.ms).fadeIn(duration: 500.ms).slideY(begin: 0.2, curve: Curves.easeOut),
                20.h.height,
                AppCustomField(
                ...
                Obx(
                  () => AppCustomField(
                    ...
                    hintText: '${AppStrings.enter} ${AppStrings.confirmPassword}',
                    ...
                    suffixIcon: GestureDetector(
                      onTap: () {
                        authController.confirmObscureText.value = !authController.confirmObscureText.value;
                      },
                      child: Icon(authController.confirmObscureText.value ? Icons.visibility_off : Icons.visibility, size: 20.sp),
                    ),
                  ),
                ).animate(delay: 600.ms).fadeIn(duration: 500.ms).slideY(begin: 0.2, curve: Curves.easeOut),
                50.h.height,
                ...
                Row(
                  ...
                  children: [
                    Text(AppStrings.alreadyHaveAccount, style: AppTextStyles.customText14(color: Colors.white.withValues(alpha: 0.7))),
                    5.w.width,
                    GestureDetector(
                      onTap: () {
                        Get.back();
                ...
                ).animate(delay: 1150.ms).fadeIn(duration: 600.ms).slideY(begin: 0.2, curve: Curves.easeOut),
              ],
            ),
