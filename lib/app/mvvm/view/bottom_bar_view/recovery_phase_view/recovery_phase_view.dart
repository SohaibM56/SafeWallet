...
class _RecoveryPhaseViewState extends State<RecoveryPhaseView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(toolBarHeight: 80.h),
      body: SafeArea(
        child: Column(
          children: [
            Obx(
              () => Row(
                ...
                children: [
                  _buildCircularView(step: 1, title: "Generate", currentStep: controller.phase.value.index + 1),
                  30.w.width,
                  _buildCircularView(step: 2, title: "Verify", currentStep: controller.phase.value.index + 1),
                  30.w.width,
                  _buildCircularView(step: 3, title: "Complete", currentStep: controller.phase.value.index + 1),
                ],
              ).animate().fadeIn(duration: AppAnimations.slow).slideY(begin: -0.2, end: 0),
            ),
            20.h.height,
            Obx(() {
  ...
  Widget _buildCircularView({required int step, required String title, required int currentStep}) {
      ...
      children: [
        Container(
              ...
              decoration: BoxDecoration(
                ...
                color: isCompleted || isActive ? Color(0xff005430) : Colors.white.withOpacity(0.1),
                border: Border.all(width: 2, color: isCompleted || isActive ? AppColors.primary : Color(0xffF1F1F7).withOpacity(0.2)),
              ),
              child: Center(
                child: isCompleted
                    ...
                    : Text(
                        ...
                        style: AppTextStyles.customText20(color: isActive ? Colors.white : Colors.white.withValues(alpha: 0.4), fontWeight: FontWeight.w500),
                      ),
              ),
            )
        ...
        child: Column(
          children: [
            ...
            Obx(
              ...
              ).paddingHorizontal(24.w).animate().fadeIn(duration: AppAnimations.normal, delay: 200.ms),
            ),
            ...
            Container(
              ...
              child: Column(
                children: [
                    ...
                    () => GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Obx(() {
                          ...
                          return WordTile(
                            word: controller.isWordHide.value == true ? "*****" : word,
                            textColor: isSelected ? Colors.white : AppColors.white.withValues(alpha: 0.5),
                            borderColor: isSelected ? AppColors.primary : AppColors.primary.withValues(alpha: 0.3),
                            color: isSelected ? AppColors.primary : AppColors.primarySoft,

                            onTap: () => controller.toggleWord(word),
                          ).animate().fadeIn(duration: AppAnimations.fast, delay: (50 * index).ms).slideY(begin: 0.3, end: 0);
                        });
                      },
                    ),
                  ),
                    ...
                    children: [
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            Clipboard.setData(ClipboardData(text: "${controller.selectedWords}"));
                            Utils.showToast("All Words copied");
                            log("${controller.selectedWords}");
                          },
                          child: SizedBox(
                            height: 40.h,
                            child: WordTile(color: AppColors.black, borderColor: AppColors.white.withOpacity(0.5), word: 'Copy', icon: Icons.copy),
                          ),
                        ),
                      ),
                      12.w.width,
                  ...
                  ).animate().fadeIn(duration: AppAnimations.normal, delay: 800.ms),
                ],
              ).paddingAll(10.sp),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Color(0xff604013).withOpacity(0.6),
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: AppTextStyles.customText(fontSize: 14.sp, color: Colors.white, fontWeight: FontWeight.w600),
                  ),
                  2.h.height,
                  Text(
                    "Anyone with access to this phrase can steal your funds.Store it offline and never enter it on any website.",
                    style: AppTextStyles.customText(fontSize: 10.sp, color: Colors.white.withValues(alpha: 0.5), fontWeight: FontWeight.w400),
                  ),
                ],
              ),
            ).animate().fadeIn(duration: AppAnimations.normal, delay: 1000.ms).slideY(begin: 0.2, end: 0),
            ...
            ).paddingHorizontal(30.w).animate().fadeIn(duration: AppAnimations.normal, delay: 1100.ms),

            10.h.height,

            AppCustomButton(
              bgColor: AppColors.white,
              textStyle: AppTextStyles.customText16(color: AppColors.black, fontWeight: FontWeight.w600),
              title: "Generate New Phrase",
              onPressed: () {},
            ).paddingHorizontal(30.w).animate().fadeIn(duration: AppAnimations.normal, delay: 1200.ms),
          ],
        ),
      ),
    );
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ).animate().fadeIn(duration: AppAnimations.fast, delay: 200.ms).slideX(begin: -0.1, end: 0),
                  16.h.height,
                  _buildSummaryTile(
                    AppAssets.checkIcon,
                    "Recovery phrase saved",
                    "Your 12/24 words have been securely generated",
                  ).animate().fadeIn(duration: AppAnimations.fast, delay: 300.ms).slideX(begin: -0.1, end: 0),
                  20.h.height,
                  _buildSummaryTile(
                    AppAssets.checkIcon,
                    "Verification complete",
                    "You've confirmed you can access your backup",
                  ).animate().fadeIn(duration: AppAnimations.fast, delay: 400.ms).slideX(begin: -0.1, end: 0),
                  20.h.height,
                  _buildSummaryTile(AppAssets.lockIcon, "Wallet protected", "Your assets are now secured by your recovery phrase"),
                  18.h.height,
                ],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ).animate().fadeIn(duration: AppAnimations.fast, delay: 600.ms),
                  14.h.height,
                  _buildSecurityTile(
                    AppAssets.solidDot,
                    "Never share it with anyone, including support staff",
                  ).animate().fadeIn(duration: AppAnimations.fast, delay: 700.ms),
                  14.h.height,
                  _buildSecurityTile(
                    AppAssets.solidDot,
                    "Store your recovery phrase in multiple secure locations",
                  ).animate().fadeIn(duration: AppAnimations.fast, delay: 800.ms),
                  18.h.height,
                ],
              ).paddingOnly(left: 14.sp, right: 20.sp).animate().fadeIn(duration: AppAnimations.slow, delay: 500.ms),
            ),
            40.h.height,
            AppCustomButton(
              title: "Return Home",
            ...
            ).paddingHorizontal(30.w).animate().fadeIn(duration: AppAnimations.normal, delay: 1000.ms).slideY(begin: 0.2, end: 0),
  ...
  Widget _buildWordsWidget({required String title, required String subTitle, required bool isSelected, required VoidCallback onTap}) {
    return Column(
      children: [
        GestureDetector(
          onTap: onTap,
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? AppColors.primary : AppColors.primarySoft,
              border: isSelected ? null : Border.all(color: AppColors.white.withOpacity(0.13)),
            ),
            child: Center(
              child: Text(title, style: AppTextStyles.customText16(color: isSelected ? AppColors.white : AppColors.white.withValues(alpha: 0.5))),
            ),
          ),
        ),
        10.h.height,
        Text(
          subTitle,
          style: AppTextStyles.customText(fontSize: 15.sp, color: isSelected ? AppColors.white : AppColors.faintColor, fontWeight: FontWeight.w500),
        ),
      ],
    );
  }
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                title,
                style: AppTextStyles.customText(fontSize: 13.sp, color: Colors.white, fontWeight: FontWeight.w500),
              ),
              Text(
                subTitle,
                style: AppTextStyles.customText10(color: Colors.white.withValues(alpha: 0.5), fontWeight: FontWeight.w500),
              ),
            ],
          ),
        ),
    ...
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Text(
            title,
            style: AppTextStyles.customText(color: Colors.white, fontSize: 11.sp, fontWeight: FontWeight.w400),
          ),
        ),
      ],
    );
          ...
          child: Stack(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFF0B6B43), borderRadius: BorderRadius.circular(20.r)),
              ).animate().slideX(begin: -1, end: 0, duration: AppAnimations.slow, curve: Curves.easeOut),
              ...
              ).animate().scale(duration: AppAnimations.normal, delay: 600.ms, curve: Curves.elasticOut),
            ],
          ),
        );
      },
