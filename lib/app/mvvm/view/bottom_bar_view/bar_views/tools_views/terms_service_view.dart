...
class TermServiceView extends StatefulWidget {
  const TermServiceView({super.key});

  @override
  State<TermServiceView> createState() => _TermServiceViewState();
}

class _TermServiceViewState extends State<TermServiceView> {
  @override
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [10.h.height, customText(), 13.h.height, customText()],
